    ...
    <header>
        ...
        <div class="mk-user">
            ...
            <div class="mk-user-info">
                ...
                <a href="login.jsp" style="text-decoration: none;"><div class="mk-user-info-lo">
    ...
    <div class="mk-main">
            ...
            <div class="mk-nav">
                ...
                <div class="mk-more-mn">
                    ...
                    <div class="mk-more-dropdown">
                        <ul>
                        <a href="/bookCategory?uid=${userobj.id}&&bookCategory=Course"> <li>Course</li></a>
                        <a href="/bookCategory?uid=${userobj.id}&&bookCategory=Comics"> <li>Comics</li></a>
                        <a href="/bookCategory?uid=${userobj.id}&&bookCategory=Historical"> <li>Historical</li></a>
                           <a href="/bookCategory?uid=${userobj.id}&&bookCategory=Mystery"><li>Mystery</li></a> 
                        <a href="/bookCategory?uid=${userobj.id}&&bookCategory=Science Fiction"> <li>Science Fiction</li></a>
                        <a href="/bookCategory?uid=${userobj.id}&&bookCategory=Horror"> <li>Horror</li></a>
                        <a href="/bookCategory?uid=${userobj.id}&&bookCategory=Adventure">  <li>Adventure</li></a>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div class="mk-it-mn mkclear mk-scroll">
            <div id="new" class="mk-ic-e mkclear">
                <h4 class="mk-ic-eh">Science Fiction</h4>
        ...
        if(countNewBook==6){
            break;
                    ...
                    <div class="mk-it-limore">
                        <a href="/bookCategory?uid=${userobj.id}&&bookCategory=Science Fiction" style="text-decoration: none;">
...
<!-- ------------- ------------------ End First Category     ------------------------------->
            ...
            <div id="comics" class="mk-ic-e mkclear">
                <h4 class="mk-ic-eh">Comics</h4>
                <div class="mk-ic-list">
        ...
        if(countcomicsBook==6){
            break;
                            ...
                            <div class="flip-card-inner">
                                <div class="flip-card-front">
                                    <div class="mk-il-bk">
                                        <div class="mk-il-bkbx">
                                            <img src="../img/bk5.jpg" />
                                            <h5>Relativity - The Special And General Theory</h5>
                                        </div>
                                        <div class="mk-il-bkact mkclear">
                                            <div class="mk-il-bkactl">
                                                <i class="fa-solid fa-indian-rupee-sign"></i>
                                ...
                                <div class="flip-card-back">
                                    <div class="mk-il-bk">
                                        <div class="mk-il-bkbx-back">
                                            <div class="mk-bk-dt-e mkclear">
                                                <span class="mk-bk-dt-el">Name :</span>
                                                <span class="mk-bk-dt-ec">Relativity - The Special And General
                                                    Theory</span>
                                            </div>
                                            <div class="mk-bk-dt-e mkclear">
                                                <span class="mk-bk-dt-el">Author :</span>
                    ...
                    <div class="mk-it-limore">
                        <a href="/bookCategory?uid=${userobj.id}&&bookCategory=Comics" style="text-decoration: none;">
                            <span><i class="fa-solid fa-arrow-right"></i></span>
                            <div>View More</div>
                        </a>
                    </div>
    ...
    <div class="mk-noti" id="mk-noti">Book Added to Cart Succesfully</div>
    </div>
    <footer>
