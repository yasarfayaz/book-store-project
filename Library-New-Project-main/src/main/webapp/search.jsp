...
<%@ page language="java" contentType="text/html; charset=ISO-8859-1" 
    pageEncoding="ISO-8859-1" %>
                ...
                <body class="mk-home">
                    ...
                    <div class="mk-main">
                        <div class="mk-pagehead mkclear">
                            <div class="mk-nav">
                                <a href="/userHome?uid=${userobj.id}" title="Home" class="mk-home-clk"><i
                                        class="fa fa-home"></i></a>
                                <a href="/bookCategory?uid=${userobj.id}&&bookCategory=comics"><i
                                        class="fa fa-book-tanakh"></i><span>Comics</span></a>
                                <a href="/bookCategory?uid=${userobj.id}&&bookCategory=historical"><i
                                        class="fa fa-book-atlas"></i><span>Historical</span></a>
                                <div class="mk-more-mn">
                                    <a id="mk-more-clk" href="#" title="More" class="mk-more-clk"><i
                ...
                <i class="fa fa-search"></i>
                            ...
                            <a href="/cartOut?uid=${userobj.id}" class="mk-add-cart-view"><i
                                    class="fa-solid fa-cart-plus"></i></a>
                        </div>
                        <% List<Books> newBooks =(List<Books>) request.getAttribute("searchBook");
                                %>
                                <div class="mk-it-mn mkclear mk-scroll">
                                    <div id="new" class="mk-ic-e mkclear">
                                        <h4 class="mk-ic-eh">You Searched For</h4>
                                                            ...
                                                            <div class="flip-card-back">
                                                                <div class="mk-il-bk">
                                                                    <div class="mk-il-bkbx-back">
                                                                        ...
                                                                        <div class="mk-bk-dt-e mkclear">
                                                                            <span class="mk-bk-dt-el">Published Year
                                                                                :</span>
                                                                            <span class="mk-bk-dt-ec">
